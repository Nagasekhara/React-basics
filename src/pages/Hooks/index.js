...
const Hooks = () => {
 ...
 const [name, setName] = useState({ first: "Ayush", last: "Verma" });
...
//  useEffect(() => {
// 	console.log("calling useEffect when name variable value is changed as componentDidUpdate");
// 	setName({ first: "Manav", last: "Yadav" });
//   }, [name]);
